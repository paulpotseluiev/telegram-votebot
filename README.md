...
python stats.py                     # статистика завершеної вікторини з архіву
```
...
| `runtime/archive/<quiz_id>.json` | підсумки завершеної вікторини: усі заявки з часом подачі й скорами, переможці, кількість голосуючих. Розбирається через `stats.py` |
